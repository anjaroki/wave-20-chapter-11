...
import Navbar from "../../components/NavbarGame";
...
function Game() {
  ...
  //   const unsub = await onSnapshot(collection(firebaseDB, "users"), (querySnapshot) => {
  ...
  return (
    <>
      ...
      <div className="text-center">
        ...
        <div>
          <a onClick={() => selectWeapon("rock")}>
            <Player weapon="rock" />
          </a>
          <a onClick={() => selectWeapon("paper")}>
            <Player weapon="paper" />
          </a>
          <a onClick={() => selectWeapon("scissors")}>
